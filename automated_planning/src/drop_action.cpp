...
bool DropAction::check_drop_preconditions()
{
  ...
  {
    std::cout << "Cannot drop when the drone is not hovering. Current state: " + anafi_state_ + "\n";
  ...
  {
    std::cout << "Horizontal distance to large. Current distance: " << horizontal_distance << "\n";
  ...
  {
    std::cout << "Altitude too high to safely drop. Is object tracked?\n";
...
void DropAction::anafi_state_cb_(std_msgs::msg::String::ConstSharedPtr state_msg)
{
...
void DropAction::ned_pos_cb_(geometry_msgs::msg::PointStamped::ConstSharedPtr ned_pos_msg)
{
...
void DropAction::detected_person_cb_(anafi_uav_interfaces::msg::DetectedPerson::ConstSharedPtr detected_person_msg)
{
...
void DropMarkerActionNode::do_work()
{
  ...
  switch (detected_severity)
  {
    ...
    case Severity::HIGH:
    {
      ...
      marker_dropped = drop_equipment_();
      break;
    }
    default:
    {
...
bool DropMarkerActionNode::drop_equipment_()
{
  if(num_markers_ > 0)
  {
    num_markers_--;
...
void DropMarkerActionNode::update_controller_of_equipment_status_()
{
...
void DropLifevestActionNode::do_work()
{
  ...
  switch (detected_severity)
  {
    ...
    case Severity::MODERATE:
    {
      RCLCPP_INFO(this->get_logger(), "Severity detected as moderate.");
      lifevest_dropped = false;
      break;
    }
    case Severity::HIGH:
    {
      ...
      lifevest_dropped = drop_equipment_();
      break;
    }
    default:
    {
...
bool DropLifevestActionNode::drop_equipment_()
{
  if(num_lifevests_ > 0)
  {
    num_lifevests_--;
...
void DropLifevestActionNode::update_controller_of_equipment_status_()
{
  auto request = std::make_shared<anafi_uav_interfaces::srv::SetEquipmentNumbers::Request>();
